...
void
SDLWindow::InitWindow(int width, int height, char* title)
{
...
b32
SDLWindow::IsGamepadConnected() override
{
    return(SDL_NumJoysticks() < 1);
}

void
SDLWindow::UpdateWindow() override
{
    SDL_GL_SwapWindow(window_);
}

void
SDLWindow::CloseWindow() override
{
...
void main()
{
    ...
    while (running)
    {
        ...
        if (is_key_down(&game_input, Keys::ESCAPE))
            running = false;
